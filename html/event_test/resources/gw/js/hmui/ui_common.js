...
var registUI = function(){
  ...
  if ( $('.wrap_contents .fnFixedTop').length ) { setTimeout(function(){_fixedTopInPage();},200); } // 스크롤에 따른 페이지 상단 fixed 고정
  if ( $('.wrap_contents .fnStickyTop').length ) { setTimeout(function(){fnStickyTop.set();},200);} // 스크롤에 따른 상단 sticky 고정
